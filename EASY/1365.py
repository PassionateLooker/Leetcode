...
# nums,
# for each nums[
#     i] find out how many numbers in the array are smaller than it.That is, for each nums[i] you have to count the number of valid j's such that j != i and nums[j] < nums[i].
#
# Return
# the
# answer in an
...
# num=[6,5,4,8]
# res=[]
# sortedNums=sorted(num)
# for i in range(len(num)):
#     count=bisect.bisect_left(sortedNums,num[i])
#     res.append(count)
# print(res)
